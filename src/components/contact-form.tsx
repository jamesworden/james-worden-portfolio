		...
		<React.Fragment>
			{messageStatus === MessageStatus.Ready ? (
				<div>
					...
					<form onSubmit={handleSubmit(onSubmit)} className='py-8 flex flex-col max-w-sm'>
						...
						<div>
							<button
								type='submit'
								className='uppercase px-4 py-2 tracking-widest dark:bg-emerald-900 bg-rose-900 transition text-white text-sm rounded-md shadow-xl tracking-widest mt-8'
							>
								Send
							</button>
						</div>
				...
				<div className='flex flex-col'>
					...
					<div>
						<button
							className='uppercase px-4 py-2 tracking-widest bg-rose-900 dark:bg-rose-900 transition text-white text-sm rounded-md shadow-xl tracking-widest mt-8'
