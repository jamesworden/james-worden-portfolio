...
export const Footer: React.FC<FooterProps> = ({ svgClass }) => (
	<footer className='w-full flex justify-around'>
		<div className='max-w-screen-xl flex pb-8 pt-2 px-safe-or-2 w-full m-auto'>
			...
			<a
				...
				target='_blank'
			>
				<svg className={svgClass} width='32' height='32' viewBox='0 0 36 35.109'>
					<path
			...
			<a
				...
				target='_blank'
			>
				<svg className={svgClass} width='32' height='23' viewBox='0 0 37.141 25.713'>
					<g
