...
interface CodeBlockSvgProps {
	svgClassName?: string;
	pathClassName?: string;
}

export const CodeBlockSvg: React.FC<CodeBlockSvgProps> = ({ svgClassName, pathClassName }) => (
	<svg
		className={cx('fill-none h-12 w-12', svgClassName)}
		viewBox='0 0 24 24'
		xmlns='http://www.w3.org/2000/svg'
	>
		<g>
			<path
				className={cx('stroke-2 stroke-black', pathClassName)}
				id='Vector'
